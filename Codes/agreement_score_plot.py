...
render_path = root / f"Data/Renders/renders_indoor"
...
render_path = root / f"Data/Renders/renders_outdoor"
## Liste des noms des images
...
def fetch_data_metric_values(domaine, method_list_paths, method_label_list, input_im_names):
    metrics_values_path = root / f"../Data/Metric_Values/Metrics_Values_{domaine.lower()}/metrics_values_train_{domaine.lower()}.json"
...
# for domaine in ["Indoor"]:
    for type_of_blender_scene in type_of_blender_scenes_label_list:
        ...
        for material in material_label_list:
            proportion_preferences_observers_path = root / f"../Data/Psychophysical_Results/Psychophysical_Results_{domaine.lower()}/{type_of_blender_scenes[type_of_blender_scenes_label_list.index(type_of_blender_scene)]}/{material_list[material_label_list.index(material)]}/proportion_preferences_observers.npy"
