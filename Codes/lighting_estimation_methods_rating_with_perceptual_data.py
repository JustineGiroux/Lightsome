...
observers_results_dir = dir_path / Path('Data/Psychophysical_Results/Psychophysical_Results_indoor/')
observers_results_outdoor_dir = dir_path / Path('Data/Psychophysical_Results/Psychophysical_Results_outdoor/')
